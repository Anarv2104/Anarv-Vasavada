...
const NOW = {
  ...
  not_doing: [
  "Shipping before I understand the system",
  "Announcing work that isn't ready to be seen",
  "Building for the pitch deck instead of production",
  ],
}
...
export default function Now() {
  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px 0' }}>
      ...
      {/* Meta row */}
      <div className="now-meta" style={{ marginBottom: 32, display: 'flex', gap: 24, flexWrap: 'wrap' }}>
        {[
      ...
      <div style={{
        ...
        Inspired by{' '}
        <a href="https://sive.rs/now" target="_blank" rel="noreferrer" style={{ color: C.blue }}>
